...
#define RETHOS_TX_BUF_SZ 800
#endif

#ifndef RETHOS_RX_BUF_SZ
#define RETHOS_RX_BUF_SZ 800
#endif

#ifndef RETHOS_NUM_RX_CONTEXTS
#define RETHOS_NUM_RX_CONTEXTS 2
#endif
...
typedef struct ethos {
  ...
  //  size_t last_framesize;  /**< size of last completed frame */
    ...
    int recv_ctx_index;
    struct rethos_recv_ctx recv_ctx[RETHOS_NUM_RX_CONTEXTS]; /* One to store received frame for processing, another to store state while receiving frames. */
